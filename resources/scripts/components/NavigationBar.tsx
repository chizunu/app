                ...
                <div className="sidebarcontent">
                    ...
                    <RightNavigation>
                        ...
                        <NavLink to={'/'} exact>
                            ...
                            <span className="navigationtext">Servidores</span>
                        </NavLink>
                        <NavLink to={'/account'}>
                            <FontAwesomeIcon icon={faUserCircle} />
                            <span className="navigationtext">Sua Conta</span>
                        </NavLink>
                        {rootAdmin &&
                            <a href={'/admin'}>
                                <FontAwesomeIcon icon={faCogs} />
                                <span className="navigationtext">Admin</span>
                            </a>
                        }
                        <a href={'/auth/logout'}>
                            <FontAwesomeIcon icon={faSignOutAlt} />
                            <span className="navigationtext">Deslogar</span>
                        </a>
                    </RightNavigation>
                </div>
            </div>
